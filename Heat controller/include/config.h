...
#define PIN_EXTERNAL_ADC_TEMP (0u)
#define PIN_EXTERNAL_ADC_NTC (1u)
#define PIN_EXTERNAL_ADC_IRON_CURRENT (2u)
#define PIN_EXTERNAL_ADC_VIN (3u)

#define I2C_ADS1115_ADDRESS 0x48
